...
def find_num_peaks(ind_w1, ind_w2, ind_w3, ind_w4, ind_w5):
    total_numPeaks = len(ind_w1) + len(ind_w2) + len(ind_w3) + len(ind_w4) + len(ind_w5)
    return total_numPeaks, len(ind_w1), len(ind_w2), len(ind_w3), len(ind_w4), len(ind_w5)
...
def find_time_of_peaks(w1, w2, w3, w4, w5, ind_w1, ind_w2, ind_w3, ind_w4, ind_w5):
    ...
    time_of_peaks = numpy.concatenate((time_of_peaks1, time_of_peaks2, time_of_peaks3, time_of_peaks4, time_of_peaks5))
